...
export interface VaultAdapterInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "balanceOf"
      | "balances"
...
export interface VaultAdapter extends BaseContract {
  connect(runner?: ContractRunner | null): VaultAdapter;
